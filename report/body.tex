        ...
        \subsubsection{Original algorithm}
            ...
            \begin{enumerate}
                ...
                \begin{itemize}
                    ...
                    \item The action set is defined as $\mathcal A = \{0, \dots, W_{\text{max}}\}$, where $a_l^\rho \in \mathcal A$ is the action taken in time slot $l$ of round $\rho$. For more details, check p. \pageref{page:actions}. In each round, a sequence of actions is selected with the aim
...
\section{Practical Problems and Backtesting}\label{section:Backtest}
    ...
    \subsection{Backtesting the algorithms}
        \begin{figure}[htbp]
            ...
            \caption{TWAP ACPR as a function of frequency of trading. $T = 200$.}
        \end{figure}

        \begin{figure}[htbp]
            \includegraphics[width=\textwidth]{ac_acpr.pdf}
            \caption{Almgren-Chriss ACPR as a function of frequency of trading. $T = 200$.}
        \end{figure}