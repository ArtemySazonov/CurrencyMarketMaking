import numpy as np
from math import sqrt, sinh, cosh, acosh, log
...
def test_TWAP_init1():
    ...
    print(
        "Testing for the correct TWAP initialisation with T = 2000, L = 100, W = 100"
    )
...
def test_TWAP_init2():
    ...
    print(
        "Testing for the correct TWAP initialisation with T = 2000, L = 1003, W = 100"
    )
...
def test_TWAP_init3():
    ...
    print(
        "Testing for the correct TWAP initialisation with T = 2000, L = 100, W = 1003"
    )
